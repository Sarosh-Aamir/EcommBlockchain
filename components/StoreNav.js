...
import SignInBtnResponsive from "./Buttons/SignInBtnResponsive";
...
export default function Example() {
    ...
    const {isAuthenticated, user, chainId, network} = useMoralis()
                    ...
                    <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setOpen}>
                        ...
                        >
                            <div
                                ...
                                <SignInBtnResponsive></SignInBtnResponsive>
                        ...
                        <div className="border-b border-gray-200">
                            <div className="h-16 flex items-center">
                                ...
                                <div className="ml-auto flex items-center">
                                    {!appUser.username && <SignInBtn></SignInBtn>}
                                    {!!appUser.username && <Logout></Logout>}
